                    ...
                    <table class="w-full">
                        ...
                        <tr class="border h-16 hover:bg-sky-50 align-baseline">
                            ...
                            <td class="flex flex-row space-x-1 p-2">
                                <a class="text-blue-500 hover:bg-blue-500 hover:text-white" href="{{ route('posts.show',$post) }}">
                                ...
                                <a class="text-green-500 hover:bg-green-500 hover:text-white" href="{{ route('posts.edit',$post) }}">
                                ...
                                <form class="" action="{{ route('posts.destroy',$post) }}" method="POST" onsubmit="return confirm('Are you sure delete the post')">
                                    @csrf
                                    @method('delete')
                                   <button class=" text-red-500 hover:bg-red-500 hover:text-white p-0.5" type="submit">
