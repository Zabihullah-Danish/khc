                    ...
                    <form action="{{ route('category.store') }}" method="POST">
                        ...
                        <div class="flex flex-row justify-center p-2 px-6">
                            ...
                            placeholder-blue-900 focus:bg-gray-50"
                             type="text" name="category" id="tag" placeholder="Enter new category" required autofocus>
                             <button class="bg-blue-500 hover:bg-blue-600 p-2 rounded text-white -ml-12">Save</button>
                        </div>
                    </form>
                </div>
                <div class="px-4 py-6">
